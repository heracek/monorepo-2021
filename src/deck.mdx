...
<Mermaid>
  ...
  PR(["PR to Design system"]) --> Tag(["Release PR"]) --> CI --> NPM --> PR1(["PR to App 1"]) --> CI1(CI 1) --> d1(Deployed 1)
  NPM --> PR2(["PR to App 2"]) --> CI2(CI 2) --> d2(Deployed 2)
`}
</Mermaid>
